  ...
  return show ? (
    ...
    <DateSelect dateTime={show.dateTime}  id={id} />
         ...
         <div className='flex justify-center mt-20 '>
          <button onClick={()=> {navigate('/movies'); scrollTo(0,0)}}className='px-10 py-3 text-sm bg-primary-dull transition rounded-md font-medium cursor-pointer'>Show More</button>
